...
const navItems = [
  ...
  { label: 'Members', path: '/superadmin/members', icon: Users },
  ...
  return (
    <div className="min-h-screen flex" style={{ background: 'var(--nm-bg)' }}>
      ...
      >
        ...
        <div className="px-5 py-5" style={{ borderBottom: '1px solid var(--nm-border)' }}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h1 className="text-base font-bold leading-tight" style={{ color: 'var(--nm-text-primary)' }}>Super Admin</h1>
                <Badge
                  variant="outline"
        ...
        {/* Bottom: ED info + Theme + Logout */}
        <div className="px-4 py-4" style={{ borderTop: '1px solid var(--nm-border)' }}>
          <div className="flex items-center justify-between">
            <div className="min-w-0">
              <p className="text-xs font-medium truncate" style={{ color: 'var(--nm-text-primary)' }} title={edMobile}>{edMobile}</p>
              <p className="text-[10px]" style={{ color: 'var(--nm-text-muted)' }}>Executive Director</p>
            </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="lg:hidden nm-header px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 flex-1">
            ...
            />
            <span className="text-sm font-semibold" style={{ color: 'var(--nm-text-primary)' }}>Super Admin</span>
          </div>
          <ThemeToggle />
        </div>
