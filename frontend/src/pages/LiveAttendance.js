  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="p-8 max-w-7xl mx-auto">
        ...
        {summary && (
          <div className="mb-8">
            <h2 className="text-xl font-bold text-slate-900 mb-4">Attendance Summary</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              ...
              <Card className="p-4 border-l-4 border-l-green-500">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-slate-900">{summary.present_count}</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-4 border-l-4 border-l-amber-500">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-slate-600">Substitutes</p>
                    <p className="text-2xl font-bold text-slate-900">{summary.substitute_count}</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-4 border-l-4 border-l-purple-500">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-slate-900">{summary.visitor_count}</p>
                  </div>
                </div>
              </Card>
            </div>
              ...
              <Card className="p-4 border-l-4 border-l-red-500 mb-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-slate-600">Pending Attendance</p>
                ...
                {showPending && (
                  <div className="mt-4 space-y-2">
                    {summary.pending_members.map((member) => (
                      <div key={member.unique_member_id} className="flex items-center justify-between p-2 bg-slate-50 rounded">
                        <div>
                          <p className="font-semibold text-slate-900">{member.full_name}</p>
                          <p className="text-sm text-slate-600">ID: {member.unique_member_id} | {member.primary_mobile}</p>
                        </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-slate-900">{summary.absent_count}</p>
                    </div>
                  </div>
                  <Button
                    variant="ghost"
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mb-8">
              <h2 className="text-xl font-bold text-slate-900 mb-4">Members & Substitutes</h2>
              {memberAttendance.length === 0 ? (
                <Card className="p-12 text-center">
                  <Users className="h-16 w-16 text-slate-300 mx-auto mb-4" />
                  <p className="text-slate-600">No member attendance marked yet</p>
                </Card>
              ) : (
            ...
            {/* Visitors Section */}
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-4">Visitors</h2>
              {visitorAttendance.length === 0 ? (
                <Card className="p-12 text-center">
                  <Users className="h-16 w-16 text-slate-300 mx-auto mb-4" />
                  <p className="text-slate-600">No visitor attendance marked yet</p>
                </Card>
              ) : (
                <div className="grid grid-cols-1 gap-4">
